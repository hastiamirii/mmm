...
map.getView().fit([5873541.291194, 4359798.613736, 5892141.727856, 4371461.130087], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">خدمات شهری قائمشهر</h2>';
        return titleElement;
    })(),
